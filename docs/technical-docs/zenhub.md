...
If you and your team are diligent in establishing time estimates for each issue that you create, you will be able to track your overall progress on the roadmap view. ZenHub calls those time estimates "story points," but it is easier to just think of them as rough working hours. Here is an example where one Epic is 47% complete and the Epic that follows is not yet begun:
